...
//
//			userLogService.addUserLog(new UserLog(null, "log demo 1", "doan", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 2", "doan", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 3", "doan", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 4", "duong", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 5", "duong", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 6", "duong", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 7", "doan", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 8", "doan", null));
//			userLogService.addUserLog(new UserLog(null, "log demo 9", "duong", null));
//		};
//	}
