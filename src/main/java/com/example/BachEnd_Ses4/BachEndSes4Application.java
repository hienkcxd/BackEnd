...
public class BachEndSes4Application {
	...
	CommandLineRunner run(UserService userService){
		return args -> {
			...
			userService.saveUser(new User(null, "The Hien", "hien", "123", new ArrayList<>(),new ArrayList<>(),new ArrayList<>()));
			userService.saveUser(new User(null, "Kieu Phong", "phong", "123", new ArrayList<>(),new ArrayList<>(),new ArrayList<>()));
			userService.saveUser(new User(null, "Doan Du", "doan", "123", new ArrayList<>(),new ArrayList<>(),new ArrayList<>()));
			userService.saveUser(new User(null, "Duong Qua", "duong", "123", new ArrayList<>(),new ArrayList<>(),new ArrayList<>()));
